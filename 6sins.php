	  ...
	  <div class="card">
        <div class="card-header"><b>Safety (Make it Safe)  Menciptakan situasi yang aman</b></div>
          <div class="card-body card-body-part">
            <div><b>1. Berapa skor audit 6S sebelumnya dan apa temuannya?</b></div>
            <form  action="routers/6s1.php" method="post" class="row g-3">
                <div class="col-md-1">
                ...
                <div class="form-group row py-4">
                  <div class="col-auto"></div>
                    ...
                    <div class="">
                      <a href="6s.php" class="btn btn-primary btn-block" type="submit" >Back</a>
                    </div>
                    <div class="">
                      <a href="6sins2.php" class="btn btn-danger btn-block" type="submit" >Next</a>
                    </div>
                </div>
              </form>
          </div>
