	  ...
	  <div class="card">
        <div class="card-header"><b>Safety (Make it Safe)  Menciptakan situasi yang aman</b></div>
          <div class="card-body card-body-part">
            <div><b>2. Informasi dan alat keamanan keselamatan digunakan</b></div>
            <form  action="routers/6s2.php" method="post" class="row g-3">
                <div class="col-md-1">
                ...
                <div class="form-group row py-4">
                  <div class="col-auto"></div>
                    ...
                    <div class="">
                      <a href="6sins.php" class="btn btn-primary btn-block" type="submit" >Back</a>
                    </div>
                    <div class="">
                      <a href="6sins3.php" class="btn btn-danger btn-block" type="submit" >Next</a>
                    </div>
                </div>
              </form>
          </div>
